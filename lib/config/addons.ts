...
export const ADDONS: Addon[] = [
  ...
  {
    id: "talishouse-420-interior",
    name: "Interior Finish Pack",
    description: "Complete interior finishing package with premium materials.",
    price: 12500,
    compatibleWith: ["talishouse-420"],
  },
  {
