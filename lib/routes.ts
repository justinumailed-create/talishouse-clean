export const ROUTES = {
  HOME: "/",
  CATALOG: "/catalogue",
  CATALOGUE_BOOKSHELF: "/catalogue/bookshelf",
  CATALOGUE_BOOKSHELF_CREATE: "/catalogue/bookshelf/create",
  ...
  ADMIN_BUILD_REQUESTS: "/admin/build-requests",
  ADMIN_MAPSITES: "/admin/mapsites",
  ...
  TALISBOOKS_ADMIN_BOOKSHELVES: "/admin/talisbooks/bookshelves",
  TALISBOOKS_CLIENT_BOOKS: "/client/books",
  TALISTV: "/talistv",
  TALISPROS_EBOOK_CHOICE: "/talispros/ebook-choice",
